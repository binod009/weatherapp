...
const NewCard = props =>{
    return(
       ...
       <hr/>
             <span style={{fontSize:"12px",color:"#b2abff",fontFamily:"serif",margin:"10px",lineHeight:"20px"}}>Feels_Like: {props.nextday!==undefined ? props.nextday.feels_like.day : '**'}℃</span>
            </div><br/>
